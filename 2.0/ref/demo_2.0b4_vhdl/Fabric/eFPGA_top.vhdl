...
entity eFPGA_top is
    ...
    Port (
        -- External IO port
        A_config_C : out STD_LOGIC_VECTOR( 55 downto 0 );
        B_config_C : out STD_LOGIC_VECTOR( 55 downto 0 );
        Config_accessC : out STD_LOGIC_VECTOR( 55 downto 0 );
        I_top      : out STD_LOGIC_VECTOR( 27 downto 0 );
        O_top      : in STD_LOGIC_VECTOR( 27 downto 0 );
        T_top      : out STD_LOGIC_VECTOR( 27 downto 0 );
...
signal RAM2FAB_D_I : STD_LOGIC_VECTOR( 224-1 downto 0 );
signal FAB2RAM_D_O : STD_LOGIC_VECTOR( 224-1 downto 0 );
signal FAB2RAM_A_O : STD_LOGIC_VECTOR( 112-1 downto 0 );
signal FAB2RAM_C_O : STD_LOGIC_VECTOR( 56-1 downto 0 );
...
eFPGA_Config_inst : eFPGA_Config
    generic map (
...
inst_Frame_Data_Reg_0 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 1
    ...
    Port map(
        ...
        FrameData_O => FrameRegister(0*FrameBitsPerRow+FrameBitsPerRow-1 downto 0*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_1 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 2
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(1*FrameBitsPerRow+FrameBitsPerRow-1 downto 1*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_2 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 3
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(2*FrameBitsPerRow+FrameBitsPerRow-1 downto 2*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_3 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 4
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(3*FrameBitsPerRow+FrameBitsPerRow-1 downto 3*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_4 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 5
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(4*FrameBitsPerRow+FrameBitsPerRow-1 downto 4*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_5 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 6
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(5*FrameBitsPerRow+FrameBitsPerRow-1 downto 5*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_6 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 7
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(6*FrameBitsPerRow+FrameBitsPerRow-1 downto 6*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_7 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 8
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(7*FrameBitsPerRow+FrameBitsPerRow-1 downto 7*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_8 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 9
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(8*FrameBitsPerRow+FrameBitsPerRow-1 downto 8*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_9 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 10
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(9*FrameBitsPerRow+FrameBitsPerRow-1 downto 9*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_10 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 11
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(10*FrameBitsPerRow+FrameBitsPerRow-1 downto 10*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_11 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 12
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(11*FrameBitsPerRow+FrameBitsPerRow-1 downto 11*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_12 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 13
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(12*FrameBitsPerRow+FrameBitsPerRow-1 downto 12*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );

inst_Frame_Data_Reg_13 : Frame_Data_Reg
    generic map (
        FrameBitsPerRow => FrameBitsPerRow,
        RowSelectWidth => RowSelectWidth,
        Row => 14
    ...
    Port map(
        FrameData_I => LocalWriteData,
        FrameData_O => FrameRegister(13*FrameBitsPerRow+FrameBitsPerRow-1 downto 13*FrameBitsPerRow),
        RowSelect => RowSelect,
        CLK => CLK
    );


inst_Frame_Select_0 : Frame_Select
    generic map (
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(0*MaxFramesPerCol+MaxFramesPerCol-1 downto 0*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_1 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 1
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(1*MaxFramesPerCol+MaxFramesPerCol-1 downto 1*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_2 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 2
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(2*MaxFramesPerCol+MaxFramesPerCol-1 downto 2*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_3 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 3
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(3*MaxFramesPerCol+MaxFramesPerCol-1 downto 3*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_4 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 4
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(4*MaxFramesPerCol+MaxFramesPerCol-1 downto 4*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_5 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 5
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(5*MaxFramesPerCol+MaxFramesPerCol-1 downto 5*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_6 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 6
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(6*MaxFramesPerCol+MaxFramesPerCol-1 downto 6*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_7 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 7
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(7*MaxFramesPerCol+MaxFramesPerCol-1 downto 7*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_8 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 8
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(8*MaxFramesPerCol+MaxFramesPerCol-1 downto 8*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );

inst_Frame_Select_9 : Frame_Select
    generic map (
        MaxFramesPerCol => MaxFramesPerCol,
        FrameSelectWidth => FrameSelectWidth,
        Col => 9
    ...
    Port map(
        FrameStrobe_I => FrameAddressRegister(MaxFramesPerCol-1 downto 0),
        FrameStrobe_O => FrameSelect(9*MaxFramesPerCol+MaxFramesPerCol-1 downto 9*MaxFramesPerCol),
        FrameSelect => FrameAddressRegister(FrameBitsPerRow-1 downto FrameBitsPerRow-FrameSelectWidth),
        FrameStrobe => LongFrameStrobe
    );
...
eFPGA_inst : eFPGA
    Port map(
        Tile_X0Y14_A_config_C0 => A_config_C(0),
        Tile_X0Y14_A_config_C1 => A_config_C(1),
        Tile_X0Y14_A_config_C2 => A_config_C(2),
        Tile_X0Y14_A_config_C3 => A_config_C(3),
        Tile_X0Y13_A_config_C0 => A_config_C(4),
        Tile_X0Y13_A_config_C1 => A_config_C(5),
        Tile_X0Y13_A_config_C2 => A_config_C(6),
        Tile_X0Y13_A_config_C3 => A_config_C(7),
        Tile_X0Y12_A_config_C0 => A_config_C(8),
        Tile_X0Y12_A_config_C1 => A_config_C(9),
        Tile_X0Y12_A_config_C2 => A_config_C(10),
        Tile_X0Y12_A_config_C3 => A_config_C(11),
        Tile_X0Y11_A_config_C0 => A_config_C(12),
        Tile_X0Y11_A_config_C1 => A_config_C(13),
        Tile_X0Y11_A_config_C2 => A_config_C(14),
        Tile_X0Y11_A_config_C3 => A_config_C(15),
        Tile_X0Y10_A_config_C0 => A_config_C(16),
        Tile_X0Y10_A_config_C1 => A_config_C(17),
        Tile_X0Y10_A_config_C2 => A_config_C(18),
        Tile_X0Y10_A_config_C3 => A_config_C(19),
        Tile_X0Y9_A_config_C0 => A_config_C(20),
        Tile_X0Y9_A_config_C1 => A_config_C(21),
        Tile_X0Y9_A_config_C2 => A_config_C(22),
        Tile_X0Y9_A_config_C3 => A_config_C(23),
        Tile_X0Y8_A_config_C0 => A_config_C(24),
        Tile_X0Y8_A_config_C1 => A_config_C(25),
        Tile_X0Y8_A_config_C2 => A_config_C(26),
        Tile_X0Y8_A_config_C3 => A_config_C(27),
        Tile_X0Y7_A_config_C0 => A_config_C(28),
        Tile_X0Y7_A_config_C1 => A_config_C(29),
        Tile_X0Y7_A_config_C2 => A_config_C(30),
        Tile_X0Y7_A_config_C3 => A_config_C(31),
        Tile_X0Y6_A_config_C0 => A_config_C(32),
        Tile_X0Y6_A_config_C1 => A_config_C(33),
        Tile_X0Y6_A_config_C2 => A_config_C(34),
        Tile_X0Y6_A_config_C3 => A_config_C(35),
        Tile_X0Y5_A_config_C0 => A_config_C(36),
        Tile_X0Y5_A_config_C1 => A_config_C(37),
        Tile_X0Y5_A_config_C2 => A_config_C(38),
        Tile_X0Y5_A_config_C3 => A_config_C(39),
        Tile_X0Y4_A_config_C0 => A_config_C(40),
        Tile_X0Y4_A_config_C1 => A_config_C(41),
        Tile_X0Y4_A_config_C2 => A_config_C(42),
        Tile_X0Y4_A_config_C3 => A_config_C(43),
        Tile_X0Y3_A_config_C0 => A_config_C(44),
        Tile_X0Y3_A_config_C1 => A_config_C(45),
        Tile_X0Y3_A_config_C2 => A_config_C(46),
        Tile_X0Y3_A_config_C3 => A_config_C(47),
        Tile_X0Y2_A_config_C0 => A_config_C(48),
        Tile_X0Y2_A_config_C1 => A_config_C(49),
        Tile_X0Y2_A_config_C2 => A_config_C(50),
        Tile_X0Y2_A_config_C3 => A_config_C(51),
        Tile_X0Y1_A_config_C0 => A_config_C(52),
        Tile_X0Y1_A_config_C1 => A_config_C(53),
        Tile_X0Y1_A_config_C2 => A_config_C(54),
        Tile_X0Y1_A_config_C3 => A_config_C(55),
        Tile_X0Y14_B_config_C0 => B_config_C(0),
        Tile_X0Y14_B_config_C1 => B_config_C(1),
        Tile_X0Y14_B_config_C2 => B_config_C(2),
        Tile_X0Y14_B_config_C3 => B_config_C(3),
        Tile_X0Y13_B_config_C0 => B_config_C(4),
        Tile_X0Y13_B_config_C1 => B_config_C(5),
        Tile_X0Y13_B_config_C2 => B_config_C(6),
        Tile_X0Y13_B_config_C3 => B_config_C(7),
        Tile_X0Y12_B_config_C0 => B_config_C(8),
        Tile_X0Y12_B_config_C1 => B_config_C(9),
        Tile_X0Y12_B_config_C2 => B_config_C(10),
        Tile_X0Y12_B_config_C3 => B_config_C(11),
        Tile_X0Y11_B_config_C0 => B_config_C(12),
        Tile_X0Y11_B_config_C1 => B_config_C(13),
        Tile_X0Y11_B_config_C2 => B_config_C(14),
        Tile_X0Y11_B_config_C3 => B_config_C(15),
        Tile_X0Y10_B_config_C0 => B_config_C(16),
        Tile_X0Y10_B_config_C1 => B_config_C(17),
        Tile_X0Y10_B_config_C2 => B_config_C(18),
        Tile_X0Y10_B_config_C3 => B_config_C(19),
        Tile_X0Y9_B_config_C0 => B_config_C(20),
        Tile_X0Y9_B_config_C1 => B_config_C(21),
        Tile_X0Y9_B_config_C2 => B_config_C(22),
        Tile_X0Y9_B_config_C3 => B_config_C(23),
        Tile_X0Y8_B_config_C0 => B_config_C(24),
        Tile_X0Y8_B_config_C1 => B_config_C(25),
        Tile_X0Y8_B_config_C2 => B_config_C(26),
        Tile_X0Y8_B_config_C3 => B_config_C(27),
        Tile_X0Y7_B_config_C0 => B_config_C(28),
        Tile_X0Y7_B_config_C1 => B_config_C(29),
        Tile_X0Y7_B_config_C2 => B_config_C(30),
        Tile_X0Y7_B_config_C3 => B_config_C(31),
        Tile_X0Y6_B_config_C0 => B_config_C(32),
        Tile_X0Y6_B_config_C1 => B_config_C(33),
        Tile_X0Y6_B_config_C2 => B_config_C(34),
        Tile_X0Y6_B_config_C3 => B_config_C(35),
        Tile_X0Y5_B_config_C0 => B_config_C(36),
        Tile_X0Y5_B_config_C1 => B_config_C(37),
        Tile_X0Y5_B_config_C2 => B_config_C(38),
        Tile_X0Y5_B_config_C3 => B_config_C(39),
        Tile_X0Y4_B_config_C0 => B_config_C(40),
        Tile_X0Y4_B_config_C1 => B_config_C(41),
        Tile_X0Y4_B_config_C2 => B_config_C(42),
        Tile_X0Y4_B_config_C3 => B_config_C(43),
        Tile_X0Y3_B_config_C0 => B_config_C(44),
        Tile_X0Y3_B_config_C1 => B_config_C(45),
        Tile_X0Y3_B_config_C2 => B_config_C(46),
        Tile_X0Y3_B_config_C3 => B_config_C(47),
        Tile_X0Y2_B_config_C0 => B_config_C(48),
        Tile_X0Y2_B_config_C1 => B_config_C(49),
        Tile_X0Y2_B_config_C2 => B_config_C(50),
        Tile_X0Y2_B_config_C3 => B_config_C(51),
        Tile_X0Y1_B_config_C0 => B_config_C(52),
        Tile_X0Y1_B_config_C1 => B_config_C(53),
        Tile_X0Y1_B_config_C2 => B_config_C(54),
        Tile_X0Y1_B_config_C3 => B_config_C(55),
        Tile_X9Y14_Config_accessC0 => Config_accessC(0),
        Tile_X9Y14_Config_accessC1 => Config_accessC(1),
        Tile_X9Y14_Config_accessC2 => Config_accessC(2),
        Tile_X9Y14_Config_accessC3 => Config_accessC(3),
        Tile_X9Y13_Config_accessC0 => Config_accessC(4),
        Tile_X9Y13_Config_accessC1 => Config_accessC(5),
        Tile_X9Y13_Config_accessC2 => Config_accessC(6),
        Tile_X9Y13_Config_accessC3 => Config_accessC(7),
        Tile_X9Y12_Config_accessC0 => Config_accessC(8),
        Tile_X9Y12_Config_accessC1 => Config_accessC(9),
        Tile_X9Y12_Config_accessC2 => Config_accessC(10),
        Tile_X9Y12_Config_accessC3 => Config_accessC(11),
        Tile_X9Y11_Config_accessC0 => Config_accessC(12),
        Tile_X9Y11_Config_accessC1 => Config_accessC(13),
        Tile_X9Y11_Config_accessC2 => Config_accessC(14),
        Tile_X9Y11_Config_accessC3 => Config_accessC(15),
        Tile_X9Y10_Config_accessC0 => Config_accessC(16),
        Tile_X9Y10_Config_accessC1 => Config_accessC(17),
        Tile_X9Y10_Config_accessC2 => Config_accessC(18),
        Tile_X9Y10_Config_accessC3 => Config_accessC(19),
        Tile_X9Y9_Config_accessC0 => Config_accessC(20),
        Tile_X9Y9_Config_accessC1 => Config_accessC(21),
        Tile_X9Y9_Config_accessC2 => Config_accessC(22),
        Tile_X9Y9_Config_accessC3 => Config_accessC(23),
        Tile_X9Y8_Config_accessC0 => Config_accessC(24),
        Tile_X9Y8_Config_accessC1 => Config_accessC(25),
        Tile_X9Y8_Config_accessC2 => Config_accessC(26),
        Tile_X9Y8_Config_accessC3 => Config_accessC(27),
        Tile_X9Y7_Config_accessC0 => Config_accessC(28),
        Tile_X9Y7_Config_accessC1 => Config_accessC(29),
        Tile_X9Y7_Config_accessC2 => Config_accessC(30),
        Tile_X9Y7_Config_accessC3 => Config_accessC(31),
        Tile_X9Y6_Config_accessC0 => Config_accessC(32),
        Tile_X9Y6_Config_accessC1 => Config_accessC(33),
        Tile_X9Y6_Config_accessC2 => Config_accessC(34),
        Tile_X9Y6_Config_accessC3 => Config_accessC(35),
        Tile_X9Y5_Config_accessC0 => Config_accessC(36),
        Tile_X9Y5_Config_accessC1 => Config_accessC(37),
        Tile_X9Y5_Config_accessC2 => Config_accessC(38),
        Tile_X9Y5_Config_accessC3 => Config_accessC(39),
        Tile_X9Y4_Config_accessC0 => Config_accessC(40),
        Tile_X9Y4_Config_accessC1 => Config_accessC(41),
        Tile_X9Y4_Config_accessC2 => Config_accessC(42),
        Tile_X9Y4_Config_accessC3 => Config_accessC(43),
        Tile_X9Y3_Config_accessC0 => Config_accessC(44),
        Tile_X9Y3_Config_accessC1 => Config_accessC(45),
        Tile_X9Y3_Config_accessC2 => Config_accessC(46),
        Tile_X9Y3_Config_accessC3 => Config_accessC(47),
        Tile_X9Y2_Config_accessC0 => Config_accessC(48),
        Tile_X9Y2_Config_accessC1 => Config_accessC(49),
        Tile_X9Y2_Config_accessC2 => Config_accessC(50),
        Tile_X9Y2_Config_accessC3 => Config_accessC(51),
        Tile_X9Y1_Config_accessC0 => Config_accessC(52),
        Tile_X9Y1_Config_accessC1 => Config_accessC(53),
        Tile_X9Y1_Config_accessC2 => Config_accessC(54),
        Tile_X9Y1_Config_accessC3 => Config_accessC(55),
...
Inst_BlockRAM_0 : BlockRAM_1KB
    Port map(
        clk => CLK,
        rd_addr => FAB2RAM_A_O(7 downto 0),
        rd_data => RAM2FAB_D_I(31 downto 0),
        wr_addr => FAB2RAM_A_O(15 downto 8),
        wr_data => FAB2RAM_D_O(31 downto 0),
        C0 => FAB2RAM_C_O(0),
        C1 => FAB2RAM_C_O(1),
        C2 => FAB2RAM_C_O(2),
        C3 => FAB2RAM_C_O(3),
...
Inst_BlockRAM_1 : BlockRAM_1KB
    Port map(
        clk => CLK,
        rd_addr => FAB2RAM_A_O(23 downto 16),
        rd_data => RAM2FAB_D_I(63 downto 32),
        wr_addr => FAB2RAM_A_O(31 downto 24),
        wr_data => FAB2RAM_D_O(63 downto 32),
        C0 => FAB2RAM_C_O(8),
        C1 => FAB2RAM_C_O(9),
        C2 => FAB2RAM_C_O(10),
        C3 => FAB2RAM_C_O(11),
...
Inst_BlockRAM_2 : BlockRAM_1KB
    Port map(
        clk => CLK,
        rd_addr => FAB2RAM_A_O(39 downto 32),
        rd_data => RAM2FAB_D_I(95 downto 64),
        wr_addr => FAB2RAM_A_O(47 downto 40),
        wr_data => FAB2RAM_D_O(95 downto 64),
        C0 => FAB2RAM_C_O(16),
        C1 => FAB2RAM_C_O(17),
        C2 => FAB2RAM_C_O(18),
        C3 => FAB2RAM_C_O(19),
...
Inst_BlockRAM_3 : BlockRAM_1KB
    Port map(
        clk => CLK,
        rd_addr => FAB2RAM_A_O(55 downto 48),
        rd_data => RAM2FAB_D_I(127 downto 96),
        wr_addr => FAB2RAM_A_O(63 downto 56),
        wr_data => FAB2RAM_D_O(127 downto 96),
        C0 => FAB2RAM_C_O(24),
        C1 => FAB2RAM_C_O(25),
        C2 => FAB2RAM_C_O(26),
        C3 => FAB2RAM_C_O(27),
...
Inst_BlockRAM_4 : BlockRAM_1KB
    Port map(
        clk => CLK,
        rd_addr => FAB2RAM_A_O(71 downto 64),
        rd_data => RAM2FAB_D_I(159 downto 128),
        wr_addr => FAB2RAM_A_O(79 downto 72),
        wr_data => FAB2RAM_D_O(159 downto 128),
        C0 => FAB2RAM_C_O(32),
        C1 => FAB2RAM_C_O(33),
        C2 => FAB2RAM_C_O(34),
        C3 => FAB2RAM_C_O(35),
...
Inst_BlockRAM_5 : BlockRAM_1KB
    Port map(
        clk => CLK,
        rd_addr => FAB2RAM_A_O(87 downto 80),
        rd_data => RAM2FAB_D_I(191 downto 160),
        wr_addr => FAB2RAM_A_O(95 downto 88),
        wr_data => FAB2RAM_D_O(191 downto 160),
        C0 => FAB2RAM_C_O(40),
        C1 => FAB2RAM_C_O(41),
        C2 => FAB2RAM_C_O(42),
        C3 => FAB2RAM_C_O(43),
...
Inst_BlockRAM_6 : BlockRAM_1KB
    Port map(
        clk => CLK,
        rd_addr => FAB2RAM_A_O(103 downto 96),
        rd_data => RAM2FAB_D_I(223 downto 192),
        wr_addr => FAB2RAM_A_O(111 downto 104),
        wr_data => FAB2RAM_D_O(223 downto 192),
        C0 => FAB2RAM_C_O(48),
        C1 => FAB2RAM_C_O(49),
        C2 => FAB2RAM_C_O(50),
        C3 => FAB2RAM_C_O(51),
...
FrameData <= X"12345678" & FrameRegister & X"12345678" after 0 ps;
