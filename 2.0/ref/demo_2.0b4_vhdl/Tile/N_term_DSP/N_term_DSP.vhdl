...
end entity N_term_DSP;
architecture Behavioral of N_term_DSP is
component N_term_DSP_switch_matrix is
    Port (
        N1END0     : in STD_LOGIC;
        N1END1     : in STD_LOGIC;
        N1END2     : in STD_LOGIC;
...
end component N_term_DSP_switch_matrix;
...
Inst_N_term_DSP_switch_matrix : N_term_DSP_switch_matrix
    Port map(
        N1END0 => N1END(0),
        N1END1 => N1END(1),
        N1END2 => N1END(2),
