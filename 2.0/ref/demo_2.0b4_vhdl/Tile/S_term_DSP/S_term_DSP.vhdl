...
end entity S_term_DSP;
architecture Behavioral of S_term_DSP is
component S_term_DSP_switch_matrix is
    Port (
        S1END0     : in STD_LOGIC;
        S1END1     : in STD_LOGIC;
        S1END2     : in STD_LOGIC;
...
end component S_term_DSP_switch_matrix;
...
Inst_S_term_DSP_switch_matrix : S_term_DSP_switch_matrix
    Port map(
        S1END0 => S1END(0),
        S1END1 => S1END(1),
        S1END2 => S1END(2),
